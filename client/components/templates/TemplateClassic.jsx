export default function TemplateClassic({ personalInfo, education, experience, skills }) {
    ...
    <div className="max-w-4xl mx-auto bg-white shadow-lg min-h-[800px] p-8 text-sm">
      ...
      <div className="text-center mb-8 border-b-2 border-gray-800 pb-6">
        ...
        {(personalInfo.linkedin || personalInfo.website) && (
          <div className="flex flex-wrap justify-center gap-6 text-gray-700 mt-2">
      ...
      {experience.some(exp => exp.company || exp.position) && (
        <div className="mb-8">
          <h2 className="text-xl font-bold text-gray-900 mb-4 uppercase tracking-wide border-b border-gray-400 pb-1">
            Experience
          </h2>
            ...
            {skills.map((skill) => (
              skill.name && (
                <div key={skill.id} className="flex justify-between items-center">
                  ...
                  <span className="text-gray-600 text-xs border border-gray-400 px-2 py-1">
                    {skill.level}
                  </span>
                </div>
              )
      ...
      {!personalInfo.fullName && !experience.some(exp => exp.company) && !education.some(edu => edu.institution) && !skills.some(skill => skill.name) && (
        <div className="text-center py-20 text-gray-500">
          ...
          <h3 className="text-xl font-semibold mb-2">Classic Resume Template</h3>
